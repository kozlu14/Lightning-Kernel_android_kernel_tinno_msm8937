...
static int smbchg_default_hvdcp_icl_ma = 1800; //Maximum charging current at HVDCP (9VDC HW Support Power Supply)
module_param_named(
...
static int smbchg_default_dcp_icl_ma = 2000; //Maximum charging current at 5VDC Supply
module_param_named(
